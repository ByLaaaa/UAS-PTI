...
function About() {
    return (
        <>
            <section className={`bg-cover bg-no-repeat bg-[url('./src/assets/img/Makannnn.jpg')] bg-gray-700 bg-blend-multiply min-h-screen`}>
                <div className="mx-auto max-w-screen-xl text-center lg:py-80">
                    ...
                    <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                        <a href="#cards" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                            Get started
